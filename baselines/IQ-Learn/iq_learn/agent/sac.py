...
from utils_iq.utils import soft_update
import agent
...
class SAC(object):
    def __init__(self, obs_dim, action_dim, action_range, batch_size, args):
        ...
        self.critic = agent.sac_models.SingleQCritic(agent_cfg.critic_cfg['obs_dim'],agent_cfg.critic_cfg['action_dim'],agent_cfg.critic_cfg['hidden_dim'],agent_cfg.critic_cfg['hidden_depth'],args).to(
            self.device)
        # hydra.utils.instantiate(agent_cfg.critic_cfg, args=args).to(self.device)
        self.critic_target = agent.sac_models.SingleQCritic(agent_cfg.critic_cfg['obs_dim'],agent_cfg.critic_cfg['action_dim'],agent_cfg.critic_cfg['hidden_dim'],agent_cfg.critic_cfg['hidden_depth'],args).to(
            self.device)
